...
const Privacy = () => (
  <div className="min-h-screen bg-background">
    <Helmet>
      ...
      <link rel="canonical" href="https://pipocamax.sbs/privacidade" />
      ...
      <meta property="og:url" content="https://pipocamax.sbs/privacidade" />
    ...
    <div className="container mx-auto px-4 pt-24 pb-16 max-w-3xl">
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
        ...
        <p>Para questões sobre privacidade: <span className="text-primary">pipocamax@proton.me</span></p>
      </div>
    </div>
    <Footer />
  </div>
