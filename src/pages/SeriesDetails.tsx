...
import { ArrowLeft, Star, Calendar, Play, Loader2, ChevronDown } from 'lucide-react';
...
const SeriesDetails = () => {
  ...
  useEffect(() => {
    if (series?.tmdb_id && selectedSeason >= 0) {
      loadEpisodes(series.tmdb_id, selectedSeason);
    }
    ...
    if (data) {
      ...
      if (data.tmdb_id) {
        const [det, cre] = await Promise.all([
          getSeriesDetails(data.tmdb_id),
          getSeriesCredits(data.tmdb_id),
        ]);
        setDetails(det);
        setCast(cre);
        // Set first real season
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 -mt-40 relative z-10 pb-12">
        ...
        {/* Player */}
        {playingEpisode && tmdbId && (
          <div className="mt-8 mb-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-display text-xl text-foreground">
                ASSISTINDO — T{playingEpisode.season} E{playingEpisode.episode}
              </h3>
              <button
            ...
            <div className="rounded-xl overflow-hidden border border-border bg-black">
              <div className="relative w-full" style={{ paddingTop: '56.25%' }}>
                <iframe
                  src={getWarezPlayerUrl('serie', tmdbId, playingEpisode.season, playingEpisode.episode)}
