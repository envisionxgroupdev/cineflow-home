...
const SeriesDetails = () => {
  ...
  const canonicalUrl = `https://pipocamax.cc/serie/assistir-${slugify(series.title)}-online-gratis`;
  const jsonLd = {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Séries', item: 'https://pipocamax.cc/series' },
