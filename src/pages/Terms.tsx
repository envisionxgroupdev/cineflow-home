...
const Terms = () => (
  <div className="min-h-screen bg-background">
    <Helmet>
      <title>Termos de Uso — Cineflow</title>
      <meta name="description" content="Termos de uso do Cineflow. Leia os termos e condições para utilização do site." />
    </Helmet>
    <Navbar />
    <div className="container mx-auto px-4 pt-24 pb-16 max-w-3xl">
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
        <p>Ao acessar e usar o Cineflow, você concorda com os seguintes termos e condições.</p>
        ...
        <p>O Cineflow atua como um agregador de conteúdo e não hospeda nenhum arquivo de mídia em seus servidores. Todo o conteúdo é fornecido por terceiros e está disponível publicamente na internet.</p>
        ...
        <p>O Cineflow não será responsável por quaisquer danos diretos, indiretos, incidentais, especiais ou consequenciais resultantes do uso ou da incapacidade de usar o serviço.</p>
